...
validate_widget_enabled "@yoru_revamped_show_git"
...
CHECK_UNTRACKED=$(is_widget_feature_enabled "@yoru_revamped_git_untracked" "1")
SHOW_WEB=$(is_widget_feature_enabled "@yoru_revamped_git_web" "1")
SHOW_STASH=$(is_widget_feature_enabled "@yoru_revamped_git_stash" "0")
SHOW_AHEAD_BEHIND=$(is_widget_feature_enabled "@yoru_revamped_git_ahead_behind" "0")
SHOW_LAST_COMMIT=$(is_widget_feature_enabled "@yoru_revamped_git_last_commit" "0")

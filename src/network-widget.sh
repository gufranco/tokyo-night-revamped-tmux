...
validate_widget_enabled "@tokyo-night-tmux_show_netspeed"

cached_output=$(get_cached_widget_output "network")
should_use_cache "$cached_output" && echo "$cached_output" && exit 0

INTERFACE=$(get_tmux_option "@tokyo-night-tmux_netspeed_iface" "")
SHOW_PING=$(is_widget_feature_enabled "@tokyo-night-tmux_netspeed_ping" "0")
SHOW_VPN=$(is_widget_feature_enabled "@tokyo-night-tmux_netspeed_vpn" "1")
SHOW_VPN_NAME=$(is_widget_feature_enabled "@tokyo-night-tmux_netspeed_vpn_name" "0")
SHOW_WIFI=$(is_widget_feature_enabled "@tokyo-night-tmux_netspeed_wifi" "0")
SHOW_CONNECTIONS=$(is_widget_feature_enabled "@tokyo-night-tmux_netspeed_connections" "0")
SHOW_INTERFACE=$(is_widget_feature_enabled "@tokyo-night-tmux_netspeed_show_interface" "0")

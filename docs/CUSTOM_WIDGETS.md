...
# Custom refresh rate
set -g @yoru_revamped_mywidget_refresh 10

# Custom options
set -g @yoru_revamped_mywidget_location "New York"
```
...
is_minimal_session && exit 0
is_widget_enabled "@yoru_revamped_show_cpu_simple" || exit 0
...
is_minimal_session && exit 0
is_widget_enabled "@yoru_revamped_show_api" || exit 0
...
is_minimal_session && exit 0
is_widget_enabled "@yoru_revamped_show_multi" || exit 0
